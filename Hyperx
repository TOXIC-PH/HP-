...
▒█░▒█ ▒█░▒█ ▒█▄▄▄█ ░▀▄▄▀ ▒█░░▀█
                   ...
                   Author   : ANIK HASUN 
		   version  : v1.0.1
		   Facebook : https://www.facebook.com/indadudhasan.anik
		   github   : /TOXIC-PH 
...
dtls=(yellow+"\t\t Created By:  ANIK HASUN BOSS")

note=(cyan+"Note: Hello MotherFucker  I wont be responsible fo any illigal activites.")
...
for i in range (amount):
	...
	print(str(i+1)+green+'.	âž™SMS Sent Mother-Fucker  ðŸ˜ˆâœ…')
	
print('					')
print(cyan+'\t\tThanks For Using LOVEBOMBER by TOXIC-PH')
